...
requests.header = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) ' 'Chrome/51.0.2704.63 Safari/537.36'}
...
for x in low_price[:10]:
    print('价格:', x[4], '\t','地点:', x[2],'\t','时间:',x[1],'\t',x[0])
